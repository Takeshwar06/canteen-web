...
const Test = () => {
  ...
  return (
    <div style={{width:"100vw",height:"100vh",backgroundColor:"black",position:'fixed',top:0,zIndex:1,display:'flex',alignItems:"center",justifyContent:"center"}}>
     ...
     { result&&<div style={{display:'flex',justifyContent:'center', width:"100vw",height:"100vh",backgroundColor:"white",position:"fixed",top:0,zIndex:999}}>
      <div style={{width:"250px",display:'flex',flexDirection:"column",marginTop:"30px"}}>
       ...
       <img style={{width:"100%"}} alt='...' src={`/upload/${result.foodimg}`}/>
      ...
      <div style={{width:"100vw"}}>
        <div onClick={()=>{setIsCameraOn(false);navigate("/message")}} style={{display:"flex",cursor:"pointer",justifyContent:'center',alignItems:"center" ,width:"50px",height:"50px",borderRadius:"50%",backgroundColor:'#3d3939',position:"absolute",top:"10px",left:'10px',zIndex:4}}>
